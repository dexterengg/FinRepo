...
public class SqlHelper : IDisposable
{
    ...
    private static void AssignParameterValues(SqlParameter[] commandParameters, object[] parameterValues)
    {
        ...
        for (int i = 0, j = commandParameters.Length; i < j; i++)
        {
            ...
            if (parameterValues.Length > k)
            {
                if (parameterValues[k] is IDbDataParameter)
                {

                    IDbDataParameter paramInstance = (IDbDataParameter)parameterValues[k];
                    ...
                    {
                        if (commandParameters[i].ParameterName.ToUpper() == paramInstance.ParameterName.ToUpper())
                        {
    ...
    public static int ExecuteNonQuery(SqlConnection connection, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
    {
        ...
        cmd.CommandTimeout = 1200; //Manoj on 05/Sep/2011
    ...
    protected virtual void Dispose(bool disposing)
    {
        ...
        //        if (!(m_sqladapter == null))
        //        {
        //            if (!(m_sqladapter.SelectCommand.Connection == null))
        //            {
        //                m_sqladapter.SelectCommand.Connection.Dispose();
        //            }
        //            m_sqladapter.SelectCommand.Dispose();
        //        }
...
public sealed class SqlHelperParameterCache
{
    ...
    /// <summary>
    /// For Validating Input string
    /// </summary>
    /// <param name="sVar"></param>
    /// <returns></returns>
    public string MakeInPutSafe(string sVar)
    {
        string sReturn = "";
        sReturn = sVar.Replace("'", "");
