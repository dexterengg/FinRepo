...
public partial class corporate_TCGHamilton : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["tcgmailerid"])))
            {
                string[] str = Convert.ToString(Request.QueryString["tcgmailerid"]).Split('?');
                if (str[0] == "68bc91cd7bdd4e6787674ae777602f3b")
                {
                    if (Session["userSessionID"] == null)
                    {
                        lt.TrackLead("tcgmailerid", "68bc91cd7bdd4e6787674ae777602f3b", "TCG_Hamilton_Google_Mailer");
                        Session["ccode"] = "C12";
                        Session["ckey"] = "68bc91cd7bdd4e6787674ae777602f3b";
                    }
                    else
                    {
                        lt.campaign_lead_capture(Session["userSessionID"].ToString(), "68bc91cd7bdd4e6787674ae777602f3b");
                        Session["Campaign"] = "68bc91cd7bdd4e6787674ae777602f3b";
                ...
                else
                {
                    if (Session["userSessionID"] == null)
                    {
                        lt.TrackLead("tcgpageid", "9c69345e6548465d99e645026b5022ae", "TCG_Hamilton_Landing_Page");
                        Session["ccode"] = "C13";
                        Session["ckey"] = "9c69345e6548465d99e645026b5022ae";
                    }
                    else
                    {
                        lt.campaign_lead_capture(Session["userSessionID"].ToString(), "9c69345e6548465d99e645026b5022ae");
                        Session["Campaign"] = "9c69345e6548465d99e645026b5022ae";
                        Response.Redirect("../SFinancialPlanning/src/Questions.aspx");
                    }
                }
            }
