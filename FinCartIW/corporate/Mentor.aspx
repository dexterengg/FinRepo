<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mentor.aspx.cs" Inherits="corporate_Mentor" %>

<!DOCTYPE html >
<html>
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Mentor Graphics | Fincart</title>
    <link rel="stylesheet" href="TCG/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="TCG/css/bootstrap-theme.min.css" type="text/css">
    <link rel="stylesheet" href="TCG/css/layout.css" type="text/css">
...
<div role="form">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                       <a href="../Default.aspx"><img src="TCG/images/logo_fincart_190x55.png" style="float: left; height: 45px;"></a> 
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <img src="mentorcss/images/Mentor_Graphics_Logo.png" style="float: right;height:47px;" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="banner">
        <div class="container">
            <div style="background:rgba(0, 0, 0, 0.5) none repeat scroll 0 0; margin-top:30px;">
            <div class="row" style="text-align: center;">
                <div class="col-lg-12">
                    <table align="center">
                        <tr>
                            <td>
                                <img src="TCG/images/logo_fincart_190x55.png" height="40" />
                            </td>
                            <td style="color:#fff;">Presents </td>
                            <td style="vertical-align: top;">
                                <h1 style="font-size: 40px; text-shadow: #CCCCCC; padding: 0px; padding-left: 10px;">FinALI </h1>
                            </td>
                        </tr>
                    </table>

                   <span style="color:#fff;">The Financial Awareness & Literacy Initiative</span> 
                </div>
            </div>

            <div class="row">
                <div class="col-lg-12" style="text-align: center;color:#fff;"><strong>FinALI </strong>helps you in <strong>3 ways </strong></div>
            </div>

            <div class="row" style="margin-top: 50px;">
                <div class="col-lg-4">
                    <img src="TCG/images/dollar.png">
                </div>
                <div class="col-lg-4">
                    <img src="TCG/images/financial-progress.png">
                </div>
                <div class="col-lg-4">
                    <img src="TCG/images/idea-plan-action.png">
                </div>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-lg-12" style="color: #fff; font-weight: bold;">
                            ...
                            Secret Formula of Wealth Creation </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row">
                        <div class="col-lg-12" style="color: #fff; font-weight: bold;">
                            ...
                            Helps you overcome the fear of Investment </div>
                    </div>
                ...
                <div class="col-lg-4" style="margin-bottom:10px;">
                    <div class="row">
                        <div class="col-lg-12" style="color: #fff; font-weight: bold;">
                            ...
                            Helps you draw your own financial plan </div>
                    </div>

                </div>
            </div>
            <!--/*--- Knowladge Financial Customized----*/ -->
                </div>
        ...
        <div class="container">
            <div style="margin-top: 100px; margin-bottom: 30px;" class="register-bg">
                <div class="row">
                    <div class="col-lg-7">
                        <table>
                            <tr>
                                <td colspan="2">
                                    <h2>Start Your Financial Progress Journey with Tanwir Alam </h2>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <img src="TCG/images/tanwir.png" />
                                </td>
                                <td>
                                    <p style="text-align: justify; padding: 0px 25px 0px 25px;">
                                        Elite Panel Speaker with <a style="color: #00aeef; font-weight: bold">http://www.moneycontrol.com/ </a>
                                        <br />
             ...
             <a style="color: #00aeef; font-weight: bold">CNBC TV18, CNBC Awaaz, Zee Business. </a>Preferred Columnist with leading print media 
                            ...
                            <tr>
                                <td colspan="2">
                                    <h2>Venue : Mentor Graphic Office, Noida </h2>
                                </td>
                            </tr>
                        </table>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    <td style="padding-bottom: 10px;">
                                        <img src="TCG/images/get-start.png">
                                    </td>
                                </tr>
               <tr> 
   <td> 
...
<input type="password" id="password" placeholder="PASSWORD" runat="server" maxlength="30" class="input-bg"/>
                            <div class="alert-danger" style="text-align: center; border-radius: 5px; margin-top: 2px;background-color:#fff;color:#ff0000;" >
                                ...
                                <tr>
                                    <td style="padding-top: 10px;">
                                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="TCG/images/exeperience-now.PNG" style="width:373px; height:60px; margin-left:2px; margin-top:10px" OnClick="ImageButton1_Click" ValidationGroup="user" />
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12" style="padding-top: 10px;">
                        Detailed Tax E-filling Worth Rs 1149/- FREE - Ask us how you can avail this for FREE.
    ...
    <div class="col-lg-10">
        ...
        <tr> 
         <td width="40"> <img src="TCG/images/number-1.png" class="img-responsive" style="height:30px;"> </td>   
         <td style="padding-left:10px;"> If they had planned any Goal </td>  <td width="100">  </td>   
        </tr>
        
        <tr> 
        <td width="40"> <img src="TCG/images/number-2.PNG" class="img-responsive" style="height:30px; margin-top:5px;"> </td>   
   ...
   <p style="text-align:left;">
    ...
    <div class="row">
    <div class="col-lg-4"> <u style="color:#0099FF; font-weight:bold;"> Group I </u> </div>
    <div class="col-lg-4"> <u style="color:#0099FF; font-weight:bold;"> Group II </u> </div>
    <div class="col-lg-4"> <u style="color:#0099FF; font-weight:bold;"> Group III </u> </div>
    </div>
    <div class="row">
    <div class="col-lg-4"> <img src="TCG/images/aero-1.PNG"> </div>
    <div class="col-lg-4"> <img src="TCG/images/aero-2.PNG"> </div>
    <div class="col-lg-4"> <img src="TCG/images/aero-3.PNG"> </div>
    </div>
    
    <div class="row">
    <div class="col-lg-4"> <p style="color:#616261; font-weight:600"> Achieved "X" </p> </div>
    <div class="col-lg-4"> <p style="color:#616261; font-weight:600"> Achieved "2X" </p> </div>
    <div class="col-lg-4"> <p style="color:#616261; font-weight:600"> Achieved 10 times more than I & II group put together   </p> </div>
    </div>
        ...
        <div class="container">
         <div class="row"> 
            ...
            <div class="register-bg" style="margin-top:100px; margin-bottom:100px;"> 
            	<div class="row"> 
                	<div class="col-lg-6">
                    <img src="TCG/images/Financial-Planning-Pyramid.png">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="hidden-lg hidden-md col-sm-12 col-xs-12">
                    <h2 style="text-align: center"><b style="font-size: 20px;">FinALI-Spreading the light of financial freedom</b></h2>
                    <b class="btn btn-lg" style="text-align: center; font-size: 13px;">Preferred panel speaker and columnist across
                        <br>
        ...
        <div class="container">
            ...
            <div class="row" style="background-color: #FFFFFF;">
                <div class="col-md-2 col-sm-6 hidden-xs">
                    <img src="TCG/images/awaz-logo.PNG" class="img-responsive" style="border-radius: 5px; height: 90px" alt="news">
                </div>
                <div class="col-md-3 col-sm-6 hidden-xs">
                    <img src="TCG/images/money-control.JPG" class="img-responsive" style="border-radius: 5px;" alt="money">
                </div>
                <div class="col-md-1 col-sm-6 hidden-xs">
                    <img src="TCG/images/Zee_Business.png" class="img-responsive" style="border-radius: 5px;" alt="zee">
                </div>
                <div class="col-md-3 col-sm-6 hidden-xs">
                    <img src="TCG/images/the-times.png" class="img-responsive" style="border-radius: 5px;" alt="ti">
                </div>
                <div class="col-md-3 col-sm-6 hidden-xs">
                    <img src="TCG/images/the-economic.JPG" class="img-responsive" style="border-radius: 5px;" alt="te">
                </div>
            </div>
            ...
            <div class="row" style="background-color: #FFFFFF;">
                <div class="hidden-lg hidden-md hidden-sm col-xs-10">
                    <img src="TCG/images/awaz-logo.PNG" class="img-responsive" style="border-radius: 5px; width: auto;" alt="news">
                </div>
                <div class="hidden-lg hidden-md hidden-sm col-xs-10">
                    <img src="TCG/images/money-control.JPG" class="img-responsive" style="border-radius: 5px; width: auto;" alt="money">
                </div>
                <div class="hidden-lg hidden-md hidden-sm col-xs-10">
                    <img src="TCG/images/Zee_Business.png" class="img-responsive" style="border-radius: 5px; width: auto" alt="zee">
                </div>
                <div class="hidden-lg hidden-md hidden-sm col-xs-10">
                    <img src="TCG/images/the-times.png" class="img-responsive" style="border-radius: 5px; width: auto" alt="ti">
                </div>
                <div class="hidden-lg hidden-md hidden-sm col-xs-10">
                    <img src="TCG/images/the-economic.JPG" class="img-responsive" style="border-radius: 5px; width: auto" alt="te">
                </div>
            </div>
