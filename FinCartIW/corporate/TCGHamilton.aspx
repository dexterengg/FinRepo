<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TCGHamilton.aspx.cs" Inherits="corporate_TCGHamilton" %>

<!DOCTYPE html >
<html>
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>TCGHamilton | Fincart</title>
        ...
        <div class="top-header">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img src="TCG/images/tcg-hamilton-logo.png" style="float: right;" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div style="margin-top: 100px; margin-bottom: 30px;" class="register-bg">
             ...
             <a style="color: #00aeef; font-weight: bold">CNBC TV18, CNBC Awaaz, Zee Business. </a>Preferred Columnist with leading print media 
                            ...
                            <tr>
                                <td colspan="2">
                                    <h2>Venue : TCG Hamilton Office, Sohna Road, Gurgaon </h2>
                                </td>
                            </tr>
                        </table>
                    </div>
