<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Teri.aspx.cs" Inherits="corporate_Teri" %>

<!DOCTYPE html >
<html>
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Teri | Fincart</title>
        ...
        <div class="top-header">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <img src="tericss/images/teri_logo.png" style="float: right;height:47px;" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div style="margin-top: 100px; margin-bottom: 30px;" class="register-bg">
             ...
             <a style="color: #00aeef; font-weight: bold">CNBC TV18, CNBC Awaaz, Zee Business. </a>Preferred Columnist with leading print media 
                            ...
                            <tr>
                                <td colspan="2">
                                    <h2>Venue : Seminar Hall, TERI IHC </h2>
                                </td>
                            </tr>
                        </table>
                    </div>
