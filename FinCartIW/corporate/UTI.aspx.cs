...
public partial class corporate_UTI : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["utimailerid"])))
            {
                string[] str = Convert.ToString(Request.QueryString["utimailerid"]).Split('?');
                if (str[0] == "ce8be7249c5e43a3ab35bb9a184be5dd")
                {
                    if (Session["userSessionID"] == null)
                    {
                        lt.TrackLead("utimailerid", "ce8be7249c5e43a3ab35bb9a184be5dd", "UTI_Google_Mailer");
                        Session["ccode"] = "C20";
                        Session["ckey"] = "ce8be7249c5e43a3ab35bb9a184be5dd";
                    }
                    else
                    {
                        lt.campaign_lead_capture(Session["userSessionID"].ToString(), "ce8be7249c5e43a3ab35bb9a184be5dd");
                        Session["Campaign"] = "ce8be7249c5e43a3ab35bb9a184be5dd";
                ...
                else
                {
                    if (Session["userSessionID"] == null)
                    {
                        lt.TrackLead("utipageid", "d713ea0b46e2481fa858ba537b23e152", "UTI_Landing_Page");
                        Session["ccode"] = "C21";
                        Session["ckey"] = "d713ea0b46e2481fa858ba537b23e152";
                    }
                    else
                    {
                        lt.campaign_lead_capture(Session["userSessionID"].ToString(), "d713ea0b46e2481fa858ba537b23e152");
                        Session["Campaign"] = "d713ea0b46e2481fa858ba537b23e152";
                        Response.Redirect("../SFinancialPlanning/src/Questions.aspx");
                    }
                }
            }
