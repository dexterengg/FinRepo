...
public partial class corporate_Teri : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["terimailerid"])))
            {
                string[] str = Convert.ToString(Request.QueryString["terimailerid"]).Split('?');
                if (str[0] == "e1c520cc2aa04101b43e2ff052049286")
                {
                    if (Session["userSessionID"] == null)
                    {
                        lt.TrackLead("terimailerid", "e1c520cc2aa04101b43e2ff052049286", "Teri_Google_Mailer");
                        Session["ccode"] = "C18";
                        Session["ckey"] = "e1c520cc2aa04101b43e2ff052049286";
                    }
                    else
                    {
                        lt.campaign_lead_capture(Session["userSessionID"].ToString(), "e1c520cc2aa04101b43e2ff052049286");
                        Session["Campaign"] = "e1c520cc2aa04101b43e2ff052049286";
                ...
                else
                {
                    if (Session["userSessionID"] == null)
                    {
                        lt.TrackLead("teriid", "242af9db628248c6a198d2dd765c239f", "Teri_Landing_Page");
                        Session["ccode"] = "C16";
                        Session["ckey"] = "242af9db628248c6a198d2dd765c239f";
                    }
                    else
                    {
                        lt.campaign_lead_capture(Session["userSessionID"].ToString(), "242af9db628248c6a198d2dd765c239f");
                        Session["Campaign"] = "242af9db628248c6a198d2dd765c239f";
                        Response.Redirect("../SFinancialPlanning/src/Questions.aspx");
                    }
                }
            }
