<%@ Page Title="" Language="C#" MasterPageFile="~/FinAdmin/MasterPage.master" AutoEventWireup="true" CodeFile="advanced-form-elements.aspx.cs" Inherits="FinAdmin_advanced_form_elements" %>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="https://gurayyarar.github.io/" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
