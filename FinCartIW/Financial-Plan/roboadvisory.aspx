<%@ Page Language="C#" AutoEventWireup="true" CodeFile="roboadvisory.aspx.cs" Inherits="Financial_Plan_roboadvisory" %>
...
<div id="forgetpassModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                       <a href="../Default.aspx"><img src="images/logo_fincart_190x55.png" style="float: left; height: 45px;"></a> 
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                       <h2 style="color:#fff; padding:0px; float:right"> Call - 011-30018181 </h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
         <div class="row"> 
            ...
            <div class="register-bg" style="margin-top:100px; margin-bottom:100px;"> 
            	<div class="row"> 
                	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <img src="images/Financial-Planning-Pyramid.png" class="img-responsive">
                    </div>
                    
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group-align">
                            <div class="form-group" style="margin-top:30px;">
                                <input type="text" id="Name1" class="form-control input-bg" placeholder="Name..." runat="server" maxlength="30" >
                            ...
                            <div class="form-group">
                                <input type="text" id="Email1" class="form-control input-bg" placeholder="Email..." runat="server" maxlength="30">
                                <div class="alert-danger" style="text-align: center; border-radius: 5px; margin-top: 2px;width:60%;">
                            ...
                            <div class="form-group" style="max-width:370px;">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="Mobile1" class="form-control input-mobile" placeholder="Mobile..." runat="server" maxlength="10">
                                </div>
                            ...
                            <div class="form-group">
                                <input type="password" id="Password1" class="form-control input-bg" placeholder="Password..." runat="server" maxlength="15" >
                                <div class="alert-danger" style="text-align: center; border-radius: 5px; margin-top: 2px;width:60%;">
              ...
              <div class="row"> 
              <div class="col-lg-12">  
              <h2> Financial planning worth <span class="amount-cros"> Rs 1149/- </span>  Free ( limited period) </h2> </div>
              </div>
                </div>
            </div>
            </div>
    ...
    <div class="col-lg-1"> </div>
         <div class="col-lg-10">    
            <h2 class="goals-text"> 
            <u> Goals – define to achieve more </u> </h2>    
            <p class="goals-contant"> 
    ...
    <div class="col-lg-1">  </div>
    <div class="col-lg-10">
    	<table class="goal-lines">
        <tr> 
         <td width="40"> <img src="images/number-1.png" class="img-responsive" style="height:30px;"> </td>   
         <td style="padding-left:10px;"> If they had planned any Goal </td>     
        </tr>
        
        <tr> 
        <td width="40"> <img src="images/number-2.PNG" class="img-responsive" style="height:30px; margin-top:5px;"> </td>   
    ...
    <b class="goals-contant"> The batch finally got segregated into 3 batches – </b> 
    </div>
    <div class="col-lg-1"> </div>
    </div>
    ...
    <div class="col-lg-1"> </div>
    <div class="col-lg-10"> 
    <table  style="text-align:left;" class="goal-lines"> 
    <tr> 
    <td width="20" style="vertical-align:top;"> A. </td> <td> There were 84 students who did not have any set Goals. </td>
    </tr>
    <tr> 
    <td width="20" style="vertical-align:top;"> B. </td> <td> There were 13 students who had set Goals but they did not write or planned a road-map </td>
    </tr>
    <tr> 
    <td width="20" style="vertical-align:top;"> C. </td> <td> Only 3 students had Written Goals. </td>
    </tr>
    </table>
    </div>
    <div class="col-lg-1"> </div>
    ...
    <div class="col-lg-1"> </div>
    <div class="col-lg-11"> 
   <p style="text-align:left;" class="goal-lines">
    ...
    <img src="images/aero-1.PNG"> <br /> 
    <p class="achived"> Achieved "X" </p>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"> 
    <u style="color:#0099FF; font-weight:bold;"> Group II </u> <br />
    <img src="images/aero-2.PNG"> <br /> 
    <p class="achived"> Achieved "2X" </p>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"> 
    <u style="color:#0099FF; font-weight:bold;"> Group III </u> <br />
    <img src="images/aero-3.PNG"> <br /> 
    <p class="achived"> Achieved 10 times more than I & II group put together   </p>
     </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                        <table>
                            <tr>
                                <td colspan="2">
                                    <h2>Start your Financial Progress Now </h2>
                                </td>
                            </tr>
                        ...
                        <table>
                                <tr>
                                    <td style="padding-bottom: 10px;">
                                        <img src="images/get-start.png" class="img-responsive Register-workshop">
                                    </td>
                                </tr>
...
<input type="password" id="password" placeholder="PASSWORD" runat="server" maxlength="30" class="input-bg"/>
                   ...
                   <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="images/exeperience-now.PNG" OnClick="ImageButton1_Click" ValidationGroup="user" class="exeperience-button" />
        ...
        Financial Planning worth <span class="amount-cros"> Rs 1149/- </span>  Free (limited period)
    ...
    <div class="know" style="background-color: #fff; color: #248ce4">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h2 class="finali-text">FinALI-Spreading the light of financial freedom </h2>
                    <b class="prefered-text" >Preferred panel speaker and columnist across leading electronic print media.</b>
                </div>
            </div>
    </div>
        ...
        <div class="container">
            <div class="row" style="background-color: #FFFFFF;">
                <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                    <img src="images/awaz-logo.PNG" class="img-responsive company-logo"  alt="news">
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <img src="images/money-control.JPG" class="img-responsive company-logo"  alt="money">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-6 col-xs-12">
                    <img src="images/Zee_Business.png" class="img-responsive company-logo"  alt="zee">
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <img src="images/the-times.png" class="img-responsive company-logo" alt="ti">
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <img src="images/the-economic.JPG" class="img-responsive company-logo" alt="te">
                </div>
            </div>
        </div>
    </div>
