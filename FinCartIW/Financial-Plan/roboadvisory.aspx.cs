...
public partial class Financial_Plan_roboadvisory : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                lt.TrackLead("bfpid", "10768cedeff247299898d30d043db8f0", "Banglore_Financial_Plan");
                Session["ccode"] = "C25";
                Session["ckey"] = "10768cedeff247299898d30d043db8f0";
            }
            else
            {
                lt.campaign_lead_capture(Session["userSessionID"].ToString(), "10768cedeff247299898d30d043db8f0");
                Session["Campaign"] = "10768cedeff247299898d30d043db8f0";
