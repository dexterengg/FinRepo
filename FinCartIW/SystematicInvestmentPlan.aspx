<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SystematicInvestmentPlan.aspx.cs" Inherits="SystematicInvestmentPlan" %>
...
<head runat="server">
  ...
  <link rel="stylesheet" href="whyshould-you-invest/css/style.css">
...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background:url(whyshould-you-invest/image/header-bg.JPG); background-repeat:repeat-x; height:63px; border:none; padding:0px;">
  ...
  <tr> 
  <td> <span style="text-align:left; color:#FFFFFF; font-size:60px; padding:0px; margin:0; height:auto; float:left;"> #IPSELFIE  </span> </td>
  </tr>
...
suggests best 3 investment choices based on the analysis and time horizon selected.
   ...
   <div class="col-lg-6 col-md-6 hidden-sm hidden-xs" style="padding-top:60px; padding-left:40px;">  
   <img src="whyshould-you-invest/image/get-start.png" style="height:auto; width:auto;" />
   <table> 
   <tr> 
   <td> 
...
<input type="password" id="password" placeholder="PASSWORD" runat="server" maxlength="30" class="input-bg"/>
  ...
  <table>  
  <tr> 
  <td colspan="" style="text-align:center"> <img src="whyshould-you-invest/image/comodo_logo.jpg" style="height:50px; width:55px; margin-left:6px;"> </td> 
  <td> 
  ...
  <tr> 
  <td colspan="2"> 
      <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="whyshould-you-invest/image/exeperience-now.PNG" style="width:373px; height:60px; margin-left:2px; margin-top:10px" OnClick="ImageButton1_Click" ValidationGroup="user" />
...
<input type="password" id="passwordxs" placeholder="PASSWORD" runat="server" maxlength="30" class="input-bg" style="width:290px;"/>
  ...
  <tr> 
  <td colspan="2"> 
      <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="whyshould-you-invest/image/exeperience-now.PNG" style="width:280px; height:50px; margin-left:2px; margin-top:10px; " OnClick="ImageButton3_Click" ValidationGroup="userxs" />
  ...
  <source src="whyshould-you-invest/image/converted_67be796d.mp4" type="video/mp4">
  <source src="whyshould-you-invest/image/converted_67be796d.ogg" type="video/ogg">
  </video>
...
<a href="http://www.bigbuckbunny.org/" target="_blank">Big Buck Bunny</a>.
 ...
 <iframe width="100%" height="400" src="https://www.youtube.com/watch?v=XJ1VlXJ3qig&feature=youtu.be" frameborder="0" allowfullscreen></iframe>
    ...
    <div class="row">   
    <div class="col-lg-12 col-md-12 hidden-sm hidden-xs" style="text-align:left;">  <h2> Key Features </h2>  </div>
    </div>
    ...
    <table style="text-align:left; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:20px; font-weight:normal; width:90%;">   
        ...
        <td style="vertical-align: text-top;"> <img src="whyshould-you-invest/image/key-frame1.PNG">  </td> <td width="10"> </td>   
        <td  style="vertical-align: text-top;"> Be Your Own Advisor  </td>  </tr>
       
        <tr style="height:80px;"> 
        <td style="vertical-align: text-top;"> <img src="whyshould-you-invest/image/key-frame2.PNG">  </td>  <td width="10"> </td>  
        <td style="vertical-align: text-top;"> Customised Investment Solution </td>  </tr>
        
        <tr style="height:80px;"> 
        <td style="vertical-align: text-top;"> <img src="whyshould-you-invest/image/key-frame3.PNG">  </td>  <td width="10"> </td>  <td style="vertical-align: text-top;"> The Suggested fund most often not only protect your hard earned money but also 
 delivers better post-tax returns  </td>  </tr>
    </table>
                        
    </div>
       
    <div class="col-lg-6 col-md-6 hidden-sm hidden-xs selfi-bg">   
    <table> 
    <tr> 
...
<input type="text" id="Email1" placeholder="EMAIL ID" runat="server" maxlength="50" class="investmentinput-bg"/>
   ...
   <tr> 
   <td> 
             <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="whyshould-you-invest/image/know-button.png" style="width:310px; margin-right:10px" OnClick="ImageButton2_Click" ValidationGroup="user1"/>
   ...
   <table>
   	<tr> 
    	<td> <img src="whyshould-you-invest/image/comodo_logo.jpg" style="height:55px;"> </td> 
   ...
   <td> </td>
    ...
    <div class="row">   
    <div class="hidden-lg hidden-md col-sm-12 col-xs-12" style="text-align:left;">  <h2> Key Features </h2>  </div>
    </div>
 ...
 delivers better post-tax returns  </td>  </tr>
    ...
    <div class=" hidden-lg hidden-md col-sm-12 col-xs-12 selfi-bg">   
    <table> 
    <tr> 
...
<input type="text" id="Email1xs" placeholder="EMAIL ID" runat="server" maxlength="50" class="investmentinput-bg" style="width:97%"/>
   ...
   <tr> 
   <td> 
             <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="whyshould-you-invest/image/know-button.png" style="width:210px; margin-right:10px" OnClick="ImageButton4_Click" ValidationGroup="user1xs"/>
...
CIN # U74140DL2012PTC245046 | ARN # 86903 | Logo Trademark # 2523746 | ISO 9001:2000 Registration # PCMS/QMS/2019-2013
	  ...
	  <img src="whyshould-you-invest/image/comodo_logo.jpg" alt="lock" style="width:auto; height:65px; margin:auto;">
  ...
  <center>
   <table align="center">
    <tr>
     <td>
      <a target="_blank" href="https://www.facebook.com/Fincartfp"><img src="whyshould-you-invest/image/facebook.jpg" alt=""></a>
     </td>
     <td>
      ...
      <img src="whyshould-you-invest/image/linkedin.jpg" alt=""></a>
     </td>
     <td>
      <a target="_blank" href="https://twitter.com/Fincartfp"><img src="whyshould-you-invest/image/twitter.jpg" alt=""></a>
     </td>
     <td>
      <a target="_blank" href="https://www.youtube.com/channel/UCPgKy0xW3ysR4aAJkwh0oEg/videos"><img src="whyshould-you-invest/image/youtube.jpg" alt=""></a>
     </td>
     <td>
      <a target="_blank" href="https://plus.google.com/+Fincartfpc"><img src="whyshould-you-invest/image/google_plus.jpg" alt=""></a>
     </td>
    </tr>
   </table>
   </center>	
