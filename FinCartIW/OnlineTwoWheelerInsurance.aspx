<%@ Page Title="" Language="C#" MasterPageFile="~/Insurance.master" AutoEventWireup="true" CodeFile="OnlineTwoWheelerInsurance.aspx.cs" Inherits="OnlineTwoWheelerInsurance" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Fincart | Online Two Wheeler Insurance</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="iframeModal" class="modal fade" role="dialog"  style="z-index:99999">
        <div class="modal-dialog" style="width: 100%;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Two Wheeler Insurance</h4>
                </div>
                <div class="modal-body">
                    <div style="background: url(InsuranceCss/loader.gif) center center no-repeat;">
                        <iframe id="carframe" width="100%" height="600px" frameborder="0" src="http://tw.policybazaar.com/partner-twowheeler?iframe=true&utm_source=FINCART&utm_medium=STRATPART&utm_term=NOTTOALLOC&utm_campaign=WEBIFRAME&name=<%=Session["LeadName"]!=null?Session["LeadName"].ToString():"" %>&email=<%=Session["LeadEmail"]!=null?Session["LeadEmail"].ToString():"" %>&mobileNo=<%=Session["LeadMobile"]!=null?Session["LeadMobile"].ToString():"" %>"></iframe>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid banner-img-twowheelar">
            ...
            <div class="row">
                <div class="col-md-5">
                    <span class="radio" style="float: right; margin-bottom: 12%; margin-right: 9%">
                        <asp:RadioButton ID="RadioButtonCar" runat="server" OnCheckedChanged="RadioButtonCar_CheckedChanged" AutoPostBack="true" />
                    </span>
                </div>
                <div class="col-md-2">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="col-md-5">
                    <span class="radio" style="float: left; margin-bottom: 12%; margin-left: 25%">
                        <asp:RadioButton ID="RadioButtonTwowheeler" runat="server" Checked="true" />
                    </span>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row" style="background-color: #2698d4; border-radius: 5px; padding-top: 1px">
                            ...
                            <div class="col-md-3" style="border-right: 1px solid #2985b8; padding: 0px; margin: 0px">
                                ...
                                <asp:TextBox type="text" name="mobile" ID="mobile" Placeholder="Mobile No." runat="server" class=" new-cutomer-input" MaxLength="10" ValidationGroup="RegisterInfo" Style="width: 79%; float: left; height: 46px; color: #fff" />
                            ...
                            <div class="col-md-3" style="background-color: #2698d4; border-right: 1px solid #2985b8; padding: 0px; margin: 0px">
                                ...
                                <asp:TextBox type="text" name="email" ID="email" runat="server" placeholder="Email Id" class=" new-cutomer-input" ValidationGroup="RegisterInfo" MaxLength="50" Style="width: 79%; float: left; height: 46px; color: #fff" />
    ...
    <div class="container-fluid fifth-portion-two-wheelar">
        <div class="container">
