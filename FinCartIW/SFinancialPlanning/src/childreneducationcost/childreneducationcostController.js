...
.controller("childreneducationcostController", ['$scope', '$state', 'decisionfactory', function ($scope, $state, decisionfactory ) {
    ...
    if (decisionfactory.getchildrenseducation()) {
        $scope.sliders = decisionfactory.getchildrenseducation();
    }
    else {
    ...
    $scope.increment = function () {
        ...
        decisionfactory.setchildrenseducation($scope.sliders);
    ...
    $scope.decrement = function () {
        ...
        decisionfactory.setchildrenseducation(false);
