...
.controller("AssettimeController", ['$scope', '$state', 'decisionfactory', function ($scope, $state, decisionfactory) {

    $scope.routehandle = decisionfactory.getroutes();

    $scope.slider = {
        value: decisionfactory.getassettime(),
        options: {
            floor: 1,
            ceil: 10,
            step: 1,
    ...
    $scope.increment = function () {
        ...
        decisionfactory.setassettime($scope.slider.value);
    ...
    $scope.decrement = function () {
        ...
        decisionfactory.setassettime(1);
