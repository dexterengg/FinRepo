...
.controller("OthercostController", ['$scope', '$state', '$window', 'decisionfactory', function ($scope, $state, $window, decisionfactory) {

    $scope.routehandle = decisionfactory.getroutes();

    $scope.slider = {
        value: decisionfactory.getothercost(),
        options: {
            floor: 5000,
            ceil: 5000000,
            step: 5000,
    ...
    $scope.increment = function () {
        ...
        decisionfactory.setothercost($scope.slider.value);
    ...
    $scope.decrement = function () {
        ...
        decisionfactory.setothercost(5000);
