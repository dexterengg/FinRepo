...
.controller("OthertimeController", ['$scope', '$state', 'decisionfactory', function ($scope, $state, decisionfactory) {

    $scope.routehandle = decisionfactory.getroutes();

    $scope.slider = {
        value: decisionfactory.getothertime(),
        options: {
            floor: 1,
            ceil: 10,
            step: 1,
    ...
    $scope.increment = function () {
        ...
        decisionfactory.setothertime($scope.slider.value);
    ...
    $scope.decrement = function () {
        ...
        decisionfactory.setothertime(1);
