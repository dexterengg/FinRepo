...
public partial class SystematicInvestmentPlan : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["userSessionID"] == null || Session["Campaign"] == null)
            {
                ...
                lt.TrackLead("SystematicInvestmentPlanid", "5d7bb630840446c095c1ec2e2cb22e73", "SystematicInvestmentPlan_Landing_page");
            }
        }
    }
    ...
    string usermanagement(string name, string email, string mobile, string pass, string type, string hfval)
    {
        ...
        try
        {
            if (type == "R")
            {
                ...
                {
                    Session["userSessionID"] = lt.registeruser(name.Trim(), email.Trim(), pass.Trim(), mobile.Trim(), "C4");
                    lt.campaign_lead_capture(email.Trim(), "5d7bb630840446c095c1ec2e2cb22e73");
                    Session["Campaign"] = "5d7bb630840446c095c1ec2e2cb22e73";
                }
            }
            else if (type == "L")
            {
                ...
                if (!String.IsNullOrWhiteSpace(usr))
                {
                    ...
                    lt.campaign_lead_capture(usr, "5d7bb630840446c095c1ec2e2cb22e73");
                    Session["Campaign"] = "5d7bb630840446c095c1ec2e2cb22e73";
                }
                else
                {
